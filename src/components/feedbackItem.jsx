...
const FeedbackItem = ({ item, onDelete }) => {
  ...
  return (
    <div className='m-6'>
      <div className='bg-gray-200 border border-customBlue3 shadow-lg max-w-xl flex justify-items-start mx-auto rounded-lg py-4 px-10 relative dark:bg-customBlue3'>
        <span
